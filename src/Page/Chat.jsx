...
class Chat extends React.Component {
    ...
    onChat = async (e) => {
        ...
        if (data.message.length !== 0) {
            ...
            await axios.post('http://localhost:5000/send-chat', data)
        }
                ...
                <div className="container d-flex justify-content-center align-items-center vh-100">
                    <div className="bg-dark h-sm-50 h-md-50 h-75 mt-n5 rounded shadow">
                        ...
                        <form className="navbar bg-white navbar-expand-sm d-flex justify-content-between rounded-bottom shadow mt-n1" onSubmit={this.onChat}>
                            ...
                            <input type="submit" value="Send" className="btn btn-info" onClick={this.onChat} disabled={this.state.error?.error && null} />
                        </form>
                        {/* ######## CHAT BOX ########*/}
                    </div>
                </div>
